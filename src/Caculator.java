...
public class Caculator {
	...
	public Caculator(int i) {
		System.out.println("----학 생 " + (i + 1) + " 성 적 표----");
	}

	public Caculator(int korea, int eng, int math) {
		this.korea = korea;
		this.eng = eng;
		this.math = math;
	}
	...
	void setAvg(int korea, int math, int eng) {
		this.avg = (korea + math + eng) / 3.0f;
	}
	float getAvg(int korea, int math, int eng) {
